...
import MadMimic from 'svgs/MadMimic';
...
const MainPage: React.FC = () => {
  ...
  */
  ...
  else if (isComputer && gpuInfo.tier <= 2) {
    return (
  ...
  return (
    <Workspace focused={game.focused} mode={game.workspaceMode} >
      ...
      <Footer>
        <Subtitle>An epic pirate-themed adventure in thrilling mix of Metroidvania and Souls-Like elements.</Subtitle>
        ...
        <Subtitle>Play right now</Subtitle>
        <Body>on your Desktop in this url.</Body>
        <div style={{ width: '100%', justifyContent: 'space-evenly' }}>
          <div style={{ padding: 15, textAlign: 'center' }}>
            <Subtitle>Web demo presented by<br />Mad Mimic</Subtitle>
            <MadMimicLogo href="https://www.madmimic.com/" target="_blank">
              <MadMimic />
            </MadMimicLogo>
          </div>
          <div style={{ padding: 15, textAlign: 'center' }}>
            <Subtitle>Powered by <br />Chaotic Games</Subtitle>
            <ChaoticLogo style={{ display: 'flex' }} href="https://www.getchaotic.com/" target="_blank">
              <Chaotic />
            </ChaoticLogo>
          </div>
        </div>
